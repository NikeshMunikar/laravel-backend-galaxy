            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('contact.create')}}" class="btn btn-info pull-right rounded"><i class="fa fa-pencil-square" aria-hidden="true">Create</i></a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="showbutton">
                                            <a href="{{route('contact.show',[$item->id])}}" class="btn btn-secondary rounded"><i class="fa fa-pencil-square-o" aria-hidden="true">View</i></a>
                                        </div>

                                        <div class="updatebutton">
                                            <a href="{{route('contact.edit',[$item->id])}}" class="btn btn-primary rounded"><i class="fa fa-pencil-square-o" aria-hidden="true">Edit</i></a>
                                        </div>
